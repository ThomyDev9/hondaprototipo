const scriptsByCampaign = {
    ...
    "lucha-apertura-de-cta": {
        header:
            "SCRIPT Código IT-EC-GO-01 · Fecha 11/02/2026 · ENCUESTA DE SATISFACCIÓN APERTURA DE CUENTA · Versión 00 · Página 1/3",
        greeting:
            "Buenos días/tardes/noches, tengo el gusto de hablar con el/la señor(a) {cliente}. Le saluda {asesor}, en representación de Cooperativa Lucha Campesina. Con el compromiso de brindar un servicio de excelencia, deseamos conocer su percepción sobre la atención recibida durante el proceso de apertura de cuenta.",
        arcotel:
        ...
        farewell:
            "Gracias por su tiempo y confianza. Sus respuestas y comentarios nos ayudan a mejorar la calidad de servicio. Que tenga un excelente día (tarde/noche).",
        objections:
